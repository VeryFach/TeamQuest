...
export default function ProjectDetails() {
    ...
    // Debug log untuk melihat semua parameter yang tersedia
    console.log('Detail page - All params received:', params);
    
    // Dalam struktur /group/[id]/projects/detail?projectId=X:
    // params akan berisi: { id: "group_id", projectId: "project_id" }
    const groupId = Array.isArray(params.id) ? params.id[0] : params.id;
    const projectId = Array.isArray(params.projectId) ? params.projectId[0] : params.projectId;
    
    console.log('Detail page - Group ID:', groupId, 'Project ID:', projectId);
    
    // Untuk sekarang, kita gunakan projectId sebagai key karena data mock masih menggunakan format lama
