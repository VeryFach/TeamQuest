  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {/* Hero Card menggunakan ProjectCard */}
        <ProjectCard
          data={{
            id: "1",
          ...
          customBgColor="#a95325"
          onPress={() => {}} // Disable navigation on detail page
        />
              ...
              {tasks.map((task) => (
                ...
                >
                  <Ionicons
                    ...
                    size={24}
                    color={task.completed ? "#374151" : "#9ca3af"}
                  />
                  <Text
                    style={[
                      styles.taskText,
...
const styles = StyleSheet.create({
  ...
  taskListContainer: { maxHeight: 320, marginBottom: 25, marginTop: 20 },
  taskItem: {
