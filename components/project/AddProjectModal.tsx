...
interface Props {
    ...
    tasks: Array<{ name: string; assignee: string }>;
    setTasks: (tasks: Array<{ name: string; assignee: string }>) => void;
}
                ...
                <View style={styles.modalContent}>
                    ...
                    >
                        ...
                        <View style={styles.taskHeader}>
                            ...
                            <Text style={[styles.label, styles.appointHeaderLabel]}>Appoint to</Text>
                        </View>
                                        ...
                                        <View style={styles.dropdown}>
                                            {ASSIGNEE_OPTIONS.map((option) => (
                                                <TouchableOpacity
                                                    ...
                                                    style={[
                                                        styles.dropdownItem,
                                                        task.assignee === option && styles.dropdownItemActive
                                                    ]}
                                                    onPress={() => updateTaskAssignee(index, option)}
                                                >
                                                    <Text style={[
                                                        styles.dropdownItemText,
                                                        task.assignee === option && styles.dropdownItemTextActive
                                                    ]}>
                                                        {option}
                                                    </Text>
